...
const LAUNCHER_VBS = [
  ...
  "",
  "' Wait for page load (ReadyState + Busy check)",
  "Dim waitCount",
  "waitCount = 0",
  "Do While (IE.Busy Or IE.ReadyState <> 4) And waitCount < 60",
  "    WScript.Sleep 500",
  ...
  "WScript.Sleep 3000",
  "",
  "' Retry loop: wait until login elements appear (max 30 sec)",
  "Dim retryMax, retryCount, elemUser, elemPass, elemBtn",
  "retryMax = 30",
  "retryCount = 0",
  "Do",
  "    Err.Clear",
  '    Set elemUser = IE.Document.getElementById("username")',
  '    Set elemPass = IE.Document.getElementById("password")',
  '    Set elemBtn  = IE.Document.getElementById("authUser")',
  "",
  "    If Not elemUser Is Nothing And Not elemPass Is Nothing And Not elemBtn Is Nothing Then",
  "        Exit Do",
  "    End If",
  "",
  "    retryCount = retryCount + 1",
  "    If retryCount >= retryMax Then",
  '        MsgBox "Login form not found after 30 seconds. Please login manually.", vbExclamation, "Timeout"',
  "        WScript.Quit",
  "    End If",
  "    WScript.Sleep 1000",
  "Loop",
  ...
  "",
  "On Error GoTo 0",
  "Set elemUser = Nothing",
  "Set elemPass = Nothing",
  "Set elemBtn = Nothing",
  "Set IE = Nothing",
].join("\r\n");
